...
class GlobalCirsiumSraAuditTests(unittest.TestCase):
    def test_compatibility_classes(self):
        ...
        self.assertEqual(
            mod.compatibility_class({"LibraryStrategy": "WGS"})[0],
            "direct_common_locus_candidate",
        )
        self.assertEqual(
            mod.compatibility_class({"LibraryStrategy": "OTHER", "LibrarySelection": "Hybrid Selection"})[0],
            "direct_common_locus_candidate",
        )
        self.assertEqual(
    ...
    def test_audit_separates_known_and_extra_runs(self):
        rows = [
            {"Run":"SRR1","BioSample":"SAMN1","BioProject":"P1","ScientificName":"Cirsium a","LibraryStrategy":"RNA-Seq","LibraryLayout":"PAIRED"},
            {"Run":"SRR2","BioSample":"SAMN2","BioProject":"P2","ScientificName":"Cirsium b","LibraryStrategy":"WGS","LibraryLayout":"PAIRED"},
            {"Run":"SRR3","BioSample":"SAMN3","BioProject":"P3","ScientificName":"Cirsium c","LibraryStrategy":"AMPLICON","LibraryLayout":"PAIRED"},
        ]
