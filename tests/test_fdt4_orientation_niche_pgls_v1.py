...
from analysis.run_fdt4_orientation_niche_pgls_v1 import brownian_covariance, fit_pgls, normalize_tip
...
def test_brownian_covariance_is_symmetric_positive_diagonal():
    tree = Phylo.read(StringIO("(OUTGROUP_saff:1,((A:1,B:1):1,(C:1,D:1):1):1);"), "newick")
