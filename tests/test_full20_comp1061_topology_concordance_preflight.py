...
class Full20Comp1061TopologyConcordancePreflightTest(unittest.TestCase):
    def test_predeclared_topology_sensitivity_contract(self):
        ...
        self.assertEqual(x["gene_tree_analysis"]["seed"], 20260822)
        self.assertIn("-st DNA", x["gene_tree_analysis"]["command_contract"])
        self.assertIn("-seed 20260822", x["gene_tree_analysis"]["command_contract"])
