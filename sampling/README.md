...
8. `aim2_capitulum_observation_bout_ledger_v1.csv` — repeated head-level time-window microclimate, pollen state, pollinator-benefit and antagonist-cost observations;
