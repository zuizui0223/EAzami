...
7. `aim2_capitulum_field_ledger_v1.csv` — focal capitulum/treatment outcomes;
8. `aim2_plant_display_predation_ledger_v1.csv` — plant-level seasonal display/predation outcomes.
