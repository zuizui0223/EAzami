...
def main()->int:
    ...
    m={'bundle_version':'east_asia_public_augmentation_hpc_bundle_v1','baseline_bundle_version':'japan_origin_global_hpc_bundle_v2','baseline_focal_tips':294,'candidate_tip_ids':[e1['tip_id'],e2['tip_id']],'candidate_strict_loci':{'EA01':e1['strict_no_warning_recovered_loci'],'EA02':e2['strict_no_warning_recovered_loci']},'scenarios':list(SCENARIOS),'same_joint_locus_set_required':True,'minimum_joint_paired_loci':contract['minimum_joint_paired_loci'],'mapping_modes':['bwa','blastx'],'tree_products':['paired concatenated IQ-TREE trees','paired per-locus IQ-TREE gene trees','paired source-label ASTRAL trees','shared-backbone RF diagnostics'],'tree_tip_promotion_allowed':False,'primary_294_tree_superseded':False,'new_china_sampling_freeze_allowed':False}
