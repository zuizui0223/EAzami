...
- 4–10 keywords;
- double-anonymous main file and separate identifying title page;
- line-numbered manuscript;
- figures near first mention, with alternative text;
- Supporting Information at submission;
- data availability, conflicts, funding and ethics declarations on the title page;
- generative-AI disclosure in cover letter and Methods or Acknowledgements.

Official guidance: https://academic.oup.com/jeb/pages/author-guidelines
